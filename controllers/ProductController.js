...
class ProductController {
    ...
    edit_product = (req, res) => {
        ...
        has_user_logged_in(req).then(user => {
            if (user && user.is_admin) {
                // fetch product by id
                this.Product.fetch_product_by_id(id)
                    .then(product => {
    ...
    product_show = (req, res) => {
        ...
        this.Product.fetch_product_by_id(ids)
            .then(product => {
    ...
    process_edit_product = (req, res) => {
        ...
        this.Product.edit_product(fields, req.session.user.id)
            .then(result => {
    ...
    remove_product = (req, res) => {
        this.Product.remove_product(req.session.user.id, req.params.id)
            .then(result => {
    ...
    process_add_product = (req, res) => {
        ...
        // add product
        this.Product.add_new_product(fields, req.session.user.id)
            .then(result => {
